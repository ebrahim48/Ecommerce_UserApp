...
import 'package:ecommerce_user_app13/auth/auth_service.dart';
import 'package:ecommerce_user_app13/models/user_model.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  void _saveOrder() {
    if(userProvider.userModel?.address == null) {
      showMsg(context, 'Please provider a delivery address');
      return;
    }
